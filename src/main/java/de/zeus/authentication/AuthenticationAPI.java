...
public class AuthenticationAPI {
     ...
     * See {@link #authenticate(String)} for the full documentation to log in.
     *
     * @param xstsResponse the response from {@link #authenticateWithXSTS(String)}
     ...
     * Then you need to authenticate with XSTS. For this method you need the XBL tokne. See {@link #authenticateWithXSTS(String)} for more information.
     ...
     * @throws Exception if something went wrong. Like if the response code is not 200 or if the response is not a valid JSON
     */
    public static LoginInToXboxLiveResponse authenticate(String accessToken) throws Exception {
